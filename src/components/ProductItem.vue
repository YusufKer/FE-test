<template>
    <div class="bg-[#C2CFFF] shadow-md rounded-md overflow-hidden">
        ...
        <div class="item-info p-2 grid gap-2">
            ...
            <div class="flex items-center gap-4 flex-wrap">
                <button @click="addToCart" class="bg-gray-100 px-4 h-10 rounded-xl w-max shrink-0 hover:shadow-md hover:bg-[#6192FA]">Add to Cart</button>
                <input ref="quantityRef" class="bg-gray-100 h-10 rounded-xl w-14 shrink-0 pl-4" type="number" min="0" max="5" value="1">
            </div>
        </div>
    </div>
</template>
